                        ...
                        <form action="{{ route('kuesioner.store') }}" method="POST" id="surveyForm" novalidate>
                            ...
                            <div id="block-0" class="survey-block">
                                ...
                                <div class="d-flex justify-content-end mt-4">
                                    <button type="button" class="btn btn-primary" onclick="nextBlock(1)">Selanjutnya &raquo;</button>
                                </div>
                            </div>
                            ...
                            <div id="block-1" class="survey-block" style="display: none;">
                                ...
                                <div class="d-flex justify-content-between mt-4">
                                    <button type="button" class="btn btn-secondary" onclick="prevBlock(0)">&laquo; Kembali</button>
