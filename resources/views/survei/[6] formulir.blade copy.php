            ...
            <div class="card shadow-sm">
                ...
                <div class="card-body p-4">
                    ...
                    <form action="{{ route('kuesioner.update', $respondent) }}" method="POST" id="surveyForm" novalidate>
                        @csrf
                        @method('PUT') {{-- Perintah khusus untuk memberi tahu Laravel ini adalah proses UPDATE --}}
                        @else
                        ...
                        {{-- ================================================================== --}} -->
                            <div id="block-1" class="survey-block">
                                ...
                                <div class="mb-3" data-required-checkbox="jenis_layanan[]">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="jenis_layanan[]" value="Pembelian Publikasi" id="layanan_pembelian_publikasi" @if(in_array('Pembelian Publikasi', old('jenis_layanan', $respondent->jenis_layanan ?? []))) checked @endif>
                                        <label class="form-check-label" for="layanan_pembelian_publikasi">Pembelian Produk Statistik Berbayar: Publikasi BPS</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="jenis_layanan[]" value="Pembelian Data Mikro" id="jenis_datamikro" @if(in_array('Pembelian Data Mikro', old('jenis_layanan', $respondent->jenis_layanan ?? []))) checked @endif>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="jenis_layanan[]" value="Akses Website" id="jenis_website" @if(in_array('Akses Website', old('jenis_layanan', $respondent->jenis_layanan ?? []))) checked @endif>
