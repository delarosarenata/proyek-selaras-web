                    ...
                    <form action="{{ route('kuesioner.store') }}" method="POST" id="surveyForm">
                        ...
                        <div id="block-1" class="survey-block">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="nama" name="nama" data-required="true" data-minlength="3">
                            ...
                            <div class="mb-3">
                                <label for="no_hp" class="form-label">3. No. Handphone</label>
                                <input type="tel" class="form-control" id="no_hp" name="no_hp" data-required="true" data-numeric="true" data-minlength="8">
                                <div class="invalid-feedback"></div>
                            </div>

                            <div class="mb-3" data-required-radio="jenis_kelamin">
                                <label class="form-label d-block">4. Jenis Kelamin</label>
                            ...
                            <div class="mb-3">
                                <label for="pendidikan_id" class="form-label d-block">5. Pendidikan Tertinggi</label>
                                <select class="form-select" name="pendidikan_id" id="pendidikan_id" data-required="true">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="lainnya-input-wrapper" id="pekerjaan_lainnya_wrapper">
                                    <input type="text" class="form-control form-control-sm mt-2" name="pekerjaan_lainnya" placeholder="Sebutkan lainnya..." data-minlength="3">
                                    <div class="invalid-feedback"></div>
                                </div>
                            </div>

                            <div class="mb-3">
                                <label for="instansi_id" class="form-label">7. Kategori Instansi</label>
                                ...
                                <div class="lainnya-input-wrapper" id="instansi_lainnya_wrapper">
                                    <input type="text" class="form-control form-control-sm mt-2" name="instansi_lainnya" placeholder="Sebutkan lainnya..." data-minlength="3">
                                    <div class="invalid-feedback"></div>
                                </div>
                            </div>

                            <div class="mb-3">
                                <label for="nama_instansi" class="form-label">8. Nama Instansi</label>
                                <input type="text" class="form-control" id="nama_instansi" name="nama_instansi" data-required="true" data-minlength="3">
                                <div class="invalid-feedback"></div>
                            </div>

                            <div class="mb-3">
                                <label for="pemanfaatan_id" class="form-label">9. Pemanfaatan Utama Hasil Kunjungan</label>
                                ...
                                <div class="lainnya-input-wrapper" id="pemanfaatan_lainnya_wrapper">
                                    <input type="text" class="form-control form-control-sm mt-2" name="pemanfaatan_lainnya" placeholder="Sebutkan lainnya..." data-minlength="3">
                                    <div class="invalid-feedback"></div>
                                </div>
                            </div>

                            <div class="mb-3" data-required-checkbox="jenis_layanan[]">
                                <label class="form-label d-block">10. Jenis Layanan yang Digunakan (Wajib pilih minimal 1)</label>
                            ...
                            <div class="mb-3" data-required-checkbox="sarana_digunakan[]">
                                <label class="form-label d-block">11. Sarana yang digunakan (Wajib pilih minimal 1)</label>
                                <div class="form-check">
                                ...
                                <div class="lainnya-input-wrapper" id="sarana_lainnya_wrapper">
                                    <input type="text" class="form-control form-control-sm mt-2" name="sarana_lainnya" placeholder="Sebutkan sarana lainnya..." data-minlength="3">
                                    <div class="invalid-feedback"></div>
                                </div>
                                <div class="invalid-feedback d-block"></div>
                            </div>
                            ...
                            <div class="mb-3" data-required-radio="pernah_pengaduan">
                                <label class="form-label d-block">12. Apakah pernah melakukan pengaduan?</label>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="pernah_pengaduan" id="pengaduan_ya" value="Ya">
                                    <label class="form-check-label" for="pengaduan_ya">Ya</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="pernah_pengaduan" id="pengaduan_tidak" value="Tidak">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="scale-container" id="scale-q1-kepentingan">
                                        @for ($i = 1; $i <= 10; $i++)
                                            ...
                                            <input type="radio" class="d-none" name="penilaian[q1][kepentingan]" id="q1-kepentingan-{{ $i }}" value="{{ $i }}">
                                            @endfor
                                    </div>
                                </div>
                                <div>
                                    ...
                                    <div class="scale-container" id="scale-q1-kepuasan">
                                        @for ($i = 1; $i <= 10; $i++)
                                            ...
                                            <input type="radio" class="d-none" name="penilaian[q1][kepuasan]" id="q1-kepuasan-{{ $i }}" value="{{ $i }}">
                                            @endfor
                                    </div>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="scale-container" id="scale-q2-kepentingan">
                                        @for ($i = 1; $i <= 10; $i++)
                                            ...
                                            <input type="radio" class="d-none" name="penilaian[q2][kepentingan]" id="q2-kepentingan-{{ $i }}" value="{{ $i }}">
                                            @endfor
                                    </div>
                                </div>
                                <div>
                                    ...
                                    <div class="scale-container" id="scale-q2-kepuasan">
                                        @for ($i = 1; $i <= 10; $i++)
                                            ...
                                            <input type="radio" class="d-none" name="penilaian[q2][kepuasan]" id="q2-kepuasan-{{ $i }}" value="{{ $i }}">
                                            @endfor
                                    </div>
                                </div>
                                <div class="invalid-feedback d-block mt-2"></div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="scale-container" id="scale-q3-kepentingan">
                                        @for ($i = 1; $i <= 10; $i++)
                                            ...
                                            <input type="radio" class="d-none" name="penilaian[q3][kepentingan]" id="q3-kepentingan-{{ $i }}" value="{{ $i }}">
                                            @endfor
                                    </div>
                                </div>
                                <div>
                                    ...
                                    <div class="scale-container" id="scale-q3-kepuasan">
                                        @for ($i = 1; $i <= 10; $i++)
                                            ...
                                            <input type="radio" class="d-none" name="penilaian[q3][kepuasan]" id="q3-kepuasan-{{ $i }}" value="{{ $i }}">
                                            @endfor
                                    </div>
                                </div>
                                <div class="invalid-feedback d-block mt-2"></div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="scale-container" id="scale-q4-kepentingan">
                                        @for ($i = 1; $i <= 10; $i++)
                                            ...
                                            <input type="radio" class="d-none" name="penilaian[q4][kepentingan]" id="q4-kepentingan-{{ $i }}" value="{{ $i }}">
                                            @endfor
                                    </div>
                                </div>
                                <div>
                                    ...
                                    <div class="scale-container" id="scale-q4-kepuasan">
                                        @for ($i = 1; $i <= 10; $i++)
                                            ...
                                            <input type="radio" class="d-none" name="penilaian[q4][kepuasan]" id="q4-kepuasan-{{ $i }}" value="{{ $i }}">
                                            @endfor
                                    </div>
                                </div>
                                <div class="invalid-feedback d-block mt-2"></div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="scale-container" id="scale-q5-kepentingan">
                                        @for ($i = 1; $i <= 10; $i++)
                                            ...
                                            <input type="radio" class="d-none" name="penilaian[q5][kepentingan]" id="q5-kepentingan-{{ $i }}" value="{{ $i }}">
                                            @endfor
                                    </div>
                                </div>
                                <div>
                                    ...
                                    <div class="scale-container" id="scale-q5-kepuasan">
                                        @for ($i = 1; $i <= 10; $i++)
                                            ...
                                            <input type="radio" class="d-none" name="penilaian[q5][kepuasan]" id="q5-kepuasan-{{ $i }}" value="{{ $i }}">
                                            @endfor
                                    </div>
                                </div>
                                <div class="invalid-feedback d-block mt-2"></div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="scale-container" id="scale-q6-kepentingan">
                                        @for ($i = 1; $i <= 10; $i++)
                                            ...
                                            <input type="radio" class="d-none" name="penilaian[q6][kepentingan]" id="q6-kepentingan-{{ $i }}" value="{{ $i }}">
                                            @endfor
                                    </div>
                                </div>
                                <div>
                                    ...
                                    <div class="scale-container" id="scale-q6-kepuasan">
                                        @for ($i = 1; $i <= 10; $i++)
                                            ...
                                            <input type="radio" class="d-none" name="penilaian[q6][kepuasan]" id="q6-kepuasan-{{ $i }}" value="{{ $i }}">
                                            @endfor
                                    </div>
                                </div>
                                <div class="invalid-feedback d-block mt-2"></div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="scale-container" id="scale-q7-kepentingan">
                                        @for ($i = 1; $i <= 10; $i++)
                                            ...
                                            <input type="radio" class="d-none" name="penilaian[q7][kepentingan]" id="q7-kepentingan-{{ $i }}" value="{{ $i }}">
                                            @endfor
                                    </div>
                                </div>
                                <div>
                                    ...
                                    <div class="scale-container" id="scale-q7-kepuasan">
                                        @for ($i = 1; $i <= 10; $i++)
                                            ...
                                            <input type="radio" class="d-none" name="penilaian[q7][kepuasan]" id="q7-kepuasan-{{ $i }}" value="{{ $i }}">
                                            @endfor
                                    </div>
                                </div>
                                <div class="invalid-feedback d-block mt-2"></div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="scale-container" id="scale-q8-kepentingan">
                                        @for ($i = 1; $i <= 10; $i++)
                                            ...
                                            <input type="radio" class="d-none" name="penilaian[q8][kepentingan]" id="q8-kepentingan-{{ $i }}" value="{{ $i }}">
                                            @endfor
                                    </div>
                                </div>
                                <div>
                                    ...
                                    <div class="scale-container" id="scale-q8-kepuasan">
                                        @for ($i = 1; $i <= 10; $i++)
                                            ...
                                            <input type="radio" class="d-none" name="penilaian[q8][kepuasan]" id="q8-kepuasan-{{ $i }}" value="{{ $i }}">
                                            @endfor
                                    </div>
                                </div>
                                <div class="invalid-feedback d-block mt-2"></div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="scale-container" id="scale-q9-kepentingan">
                                        @for ($i = 1; $i <= 10; $i++)
                                            ...
                                            <input type="radio" class="d-none" name="penilaian[q9][kepentingan]" id="q9-kepentingan-{{ $i }}" value="{{ $i }}">
                                            @endfor
                                    </div>
                                </div>
                                <div>
                                    ...
                                    <div class="scale-container" id="scale-q9-kepuasan">
                                        @for ($i = 1; $i <= 10; $i++)
                                            ...
                                            <input type="radio" class="d-none" name="penilaian[q9][kepuasan]" id="q9-kepuasan-{{ $i }}" value="{{ $i }}">
                                            @endfor
                                    </div>
                                </div>
                                <div class="invalid-feedback d-block mt-2"></div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="scale-container" id="scale-q10-kepentingan">
                                        @for ($i = 1; $i <= 10; $i++)
                                            ...
                                            <input type="radio" class="d-none" name="penilaian[q10][kepentingan]" id="q10-kepentingan-{{ $i }}" value="{{ $i }}">
                                            @endfor
                                    </div>
                                </div>
                                <div>
                                    ...
                                    <div class="scale-container" id="scale-q10-kepuasan">
                                        @for ($i = 1; $i <= 10; $i++)
                                            ...
                                            <input type="radio" class="d-none" name="penilaian[q10][kepuasan]" id="q10-kepuasan-{{ $i }}" value="{{ $i }}">
                                            @endfor
                                    </div>
                                </div>
                                <div class="invalid-feedback d-block mt-2"></div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="scale-container" id="scale-q11-kepentingan">
                                        @for ($i = 1; $i <= 10; $i++)
                                            ...
                                            <input type="radio" class="d-none" name="penilaian[q11][kepentingan]" id="q11-kepentingan-{{ $i }}" value="{{ $i }}">
                                            @endfor
                                    </div>
                                </div>
                                <div>
                                    ...
                                    <div class="scale-container" id="scale-q11-kepuasan">
                                        @for ($i = 1; $i <= 10; $i++)
                                            ...
                                            <input type="radio" class="d-none" name="penilaian[q11][kepuasan]" id="q11-kepuasan-{{ $i }}" value="{{ $i }}">
                                            @endfor
                                    </div>
                                </div>
                                <div class="invalid-feedback d-block mt-2"></div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="scale-container" id="scale-q13-kepentingan">
                                        @for ($i = 1; $i <= 10; $i++)
                                            ...
                                            <input type="radio" class="d-none" name="penilaian[q13][kepentingan]" id="q13-kepentingan-{{ $i }}" value="{{ $i }}">
                                            @endfor
                                    </div>
                                </div>
                                <div>
                                    ...
                                    <div class="scale-container" id="scale-q13-kepuasan">
                                        @for ($i = 1; $i <= 10; $i++)
                                            ...
                                            <input type="radio" class="d-none" name="penilaian[q13][kepuasan]" id="q13-kepuasan-{{ $i }}" value="{{ $i }}">
                                            @endfor
                                    </div>
                                </div>
                                <div class="invalid-feedback d-block mt-2"></div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="scale-container" id="scale-q14-kepentingan">
                                        @for ($i = 1; $i <= 10; $i++)
                                            ...
                                            <input type="radio" class="d-none" name="penilaian[q14][kepentingan]" id="q14-kepentingan-{{ $i }}" value="{{ $i }}">
                                            @endfor
                                    </div>
                                </div>
                                <div>
                                    ...
                                    <div class="scale-container" id="scale-q14-kepuasan">
                                        @for ($i = 1; $i <= 10; $i++)
                                            ...
                                            <input type="radio" class="d-none" name="penilaian[q14][kepuasan]" id="q14-kepuasan-{{ $i }}" value="{{ $i }}">
                                            @endfor
                                    </div>
                                </div>
                                <div class="invalid-feedback d-block mt-2"></div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="scale-container" id="scale-q15-kepentingan">
                                        @for ($i = 1; $i <= 10; $i++)
                                            ...
                                            <input type="radio" class="d-none" name="penilaian[q15][kepentingan]" id="q15-kepentingan-{{ $i }}" value="{{ $i }}">
                                            @endfor
                                    </div>
                                </div>
                                <div>
                                    ...
                                    <div class="scale-container" id="scale-q15-kepuasan">
                                        @for ($i = 1; $i <= 10; $i++)
                                            ...
                                            <input type="radio" class="d-none" name="penilaian[q15][kepuasan]" id="q15-kepuasan-{{ $i }}" value="{{ $i }}">
                                            @endfor
                                    </div>
                                </div>
                                <div class="invalid-feedback d-block mt-2"></div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="scale-container" id="scale-q16-kepentingan">
                                        @for ($i = 1; $i <= 10; $i++)
                                            ...
                                            <input type="radio" class="d-none" name="penilaian[q16][kepentingan]" id="q16-kepentingan-{{ $i }}" value="{{ $i }}">
                                            @endfor
                                    </div>
                                </div>
                                <div>
                                    ...
                                    <div class="scale-container" id="scale-q16-kepuasan">
                                        @for ($i = 1; $i <= 10; $i++)
                                            ...
                                            <input type="radio" class="d-none" name="penilaian[q16][kepuasan]" id="q16-kepuasan-{{ $i }}" value="{{ $i }}">
                                            @endfor
                                    </div>
                                </div>
                                <div class="invalid-feedback d-block mt-2"></div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="scale-container" id="scale-q17-kepentingan">
                                        @for ($i = 1; $i <= 10; $i++)
                                            ...
                                            <input type="radio" class="d-none" name="penilaian[q17][kepentingan]" id="q17-kepentingan-{{ $i }}" value="{{ $i }}">
                                            @endfor
                                    </div>
                                </div>
                                <div>
                                    ...
                                    <div class="scale-container" id="scale-q17-kepuasan">
                                        @for ($i = 1; $i <= 10; $i++)
                                            ...
                                            <input type="radio" class="d-none" name="penilaian[q17][kepuasan]" id="q17-kepuasan-{{ $i }}" value="{{ $i }}">
                                            @endfor
                                    </div>
                                </div>
                                <div class="invalid-feedback d-block mt-2"></div>
...
<script>
    ...
    function nextBlock(nextBlockNumber) {
    ...
    function prevBlock(prevBlockNumber) {
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        simpanBtn.addEventListener('click', function() {
            ...
            const formData = {
                ...
                tahun_data: modalElement.querySelector('#tahun_data').value.trim(),
            ...
            if (!formData.tahun_data) showError('tahun_data', 'Tahun data wajib diisi.');
            ...
            if (!isModalValid) {
                if (firstInvalidModalField) {
                    firstInvalidModalField.scrollIntoView({
                        behavior: 'smooth',
                        block: 'center'
                    });
                }
        ...
        surveyForm.addEventListener('submit', function(event) {
            ...
            if (!isFormValid) {
                ...
                const penilaianData = {};
                document.querySelectorAll('#block-2 [data-penilaian-question]').forEach(q => {
                    const questionId = q.dataset.penilaianQuestion;
                    if (q.offsetParent !== null) {
                        penilaianData[questionId] = {
                            kepentingan: q.querySelector(`input[name="penilaian[${questionId}][kepentingan]"]:checked`)?.value,
                            kepuasan: q.querySelector(`input[name="penilaian[${questionId}][kepuasan]"]:checked`)?.value
                        };
                    }
                });
